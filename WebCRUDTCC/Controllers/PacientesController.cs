...
namespace WebCRUDTCC.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,DataNasc")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,DataNasc")] Paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
